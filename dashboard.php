...
<div class="row" id="bar">
    <div class="col-sm-10 heading" id="up">RAJ-Travels</div>
...
if(isset($_POST['deleteTrip']))
{
    ...
    if($resultx == True)
    {
		...
		require("C:/xampp/htdocs/RAJ-Travels/PHPMailer/src/PHPMailer.php");
		require("C:/xampp/htdocs/RAJ-Travels/PHPMailer/src/SMTP.php");
		require("C:/xampp/htdocs/RAJ-Travels/PHPMailer/src/Exception.php");
	    $mail = new PHPMailer;
