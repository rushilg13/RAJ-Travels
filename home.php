...
<body data-spy="scroll" data-target=".navbar" data-offset="10">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
        <a class="navbar-brand heading" href="#">RAJ-Travels</a>
  ...
  ?>
    ...
    <!--footer-->
    	...
    	<div class="container-fluid text-center text-md-left">
      		<div class="row">
        		<div class="col-md-6 mt-md-0 mt-3">
          			...
          			<p class="footerText"><i class="fa fa-envelope icon" aria-hidden="true"></i> help@RAJ-Travels.com</p>
    	...
    	<div class="footer-copyright text-center py-3 madeby">
    		Made by<font style="color: #ffc312;"> Rushil, Adarsh and Janvi</font>
    	</div>
  	</footer>
<!--Bootstrap JS-->
